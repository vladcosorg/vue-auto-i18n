...
class TranslationApi {
    ...
    translate(targetLanguage, messages) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield node_fetch_1.default((_a = this.apiProxyURL) !== null && _a !== void 0 ? _a : 'https://translation.googleapis.com/language/translate/v2', { method: 'POST', body: params });
            ...
            if (!response.ok) {
                ...
                throw new error_1.InformativeError('The API return an error response', {
                    data: jsonReponse,
                });
            }
            ...
            if (!translatedText) {
                throw new error_1.InformativeError('Unexpected response structure', {
                    response,
                });
            }
